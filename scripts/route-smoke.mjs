...
await page('/flows?repository=Zeek&revision=main&bundle=b_demo1234', ['Which flow is represented in this snapshot?', 'Graph-backed bundle requested', 'Open Architecture loader', 'Open Lachesis context', 'opengraph-image?repository=Zeek&amp;revision=main&amp;bundle=b_demo1234']);
...
await page('/flows/packet-decode?repository=Zeek&revision=main&bundle=b_demo1234&step=ipv4', ['Architectural flow snapshot', 'Graph-backed bundle requested', 'Open Architecture loader', 'Open Lachesis context', 'opengraph-image?repository=Zeek&amp;revision=main&amp;bundle=b_demo1234']);
