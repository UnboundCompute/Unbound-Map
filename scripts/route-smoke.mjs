...
await page('/?repository=Zeek&revision=main&bundle=b_demo123', ['Zeek architecture snapshot', 'Graph-backed bundle requested', 'Preparing a verified repository map.', 'Open Architecture loader', 'Open Lachesis context', 'full revision', 'Not supplied by snapshot', 'href="https://lachesis.unboundcompute.com/?repository=Zeek&amp;revision=main&amp;bundle=b_demo123"']);
