...
await page('/flows?repository=Zeek&revision=main&bundle=b_demo1234', ['Graph-backed bundle requested', 'Open Architecture loader', 'Open Lachesis context', 'opengraph-image?repository=Zeek&amp;revision=main&amp;bundle=b_demo1234']);
...
await page('/flows/packet-decode?repository=Zeek&revision=main&bundle=b_demo1234&step=ipv4', ['Graph-backed bundle requested', 'Open Architecture loader', 'Open Lachesis context', 'opengraph-image?repository=Zeek&amp;revision=main&amp;bundle=b_demo1234']);
