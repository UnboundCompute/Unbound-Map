...
await page('/architecture', ['receives from', 'hands off to', 'The projection, in words', 'Wire input enters Packet input']);
...
await page('/explore?repository=Zeek&revision=main&region=decode&anchor=DecodeIPV4%28%29&bundle=b_demo123', ['Context ready', 'DecodeIPV4()', 'b_demo123', 'Trace', 'Reviewed findings and adjudicated evidence', 'aria-label="Open DecodeIPV4() in Lachesis in a new tab"', 'href="/explore?repository=Zeek&amp;revision=main&amp;bundle=b_demo123&amp;region=decode&amp;anchor=DecodeIPV4%28%29"']);
