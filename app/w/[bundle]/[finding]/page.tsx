...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return documentMetadata(`${label} · Security Witness · Unbound Map`, `Read a revision-pinned graph evidence witness for ${identity.repository ?? 'this repository snapshot'}.`, { ...identity, bundle, finding: label, canonicalPath: `/w/${encodeURIComponent(bundle)}/${encodeURIComponent(finding)}` });
}
