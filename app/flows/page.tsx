...
export const metadata: Metadata = { title: 'Suricata architectural flows · Design Map', description: 'Follow a canonical packet journey from network bytes into flow state, one design boundary at a time.' };
