  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      for (let attempt = 0; attempt < 180; attempt += 1) {
        ...
        if (remaining <= 0) throw new Error('The build is still running. Try the indexed repository list in a few minutes.');
      ...
      throw new Error('The build is still running. Try the indexed repository list in a few minutes.');
    } catch (error) {
